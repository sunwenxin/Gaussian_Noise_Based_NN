...
def scatter_hist(data, ax, ax_histx, ax_histy):
    ...
    ax.legend([h1[0], h2[0]], ['PDF of $\mathbf d$', 'PDF of $\mathbf y-\hat\mathbf y$'])
    ...
    ax.set_xlabel('$\mathbf d_1$ and $\mathbf y_1-\hat\mathbf y_1$')
    ax.set_ylabel('$\mathbf d_2$ and $\mathbf y_2-\hat\mathbf y_2$')
